...
class MyWrappers extends Wrapper
{
    ...
    # a couple of starter wrappers have been included for you to play with, feel free to delete them

    # follow the naming convention: if you want your wrapper to be named 'my_wrapper', then your 
    # wrapper method needs to be named 'my_wrapper()' and your css method needs to be named 'my_wrapper_css()'
    ...
    # the following methods are an example of a really basic wrapper.
    # this demonstrates that your wrappers can be as simple - or as complex (as seen below) - as you like.
    ...
    public static function simple_wrapper_css($key = '')
    {
        ...
        # just need to have the keys here so Formr doesn't throw an error.
    ...
    # my_wrapper's css classes
    public static function my_wrapper_css($key = '')
    {
        ...
        # Formr will look up the class name by the key so the key name must stay the same, however the values can be whatever you want.
        ...
        $array = [
            ...
            'button' => 'btn btn-primary',        // example: <button class="btn btn-primary">
